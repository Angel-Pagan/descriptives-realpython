...
#mean or fmean, but fmean is faster. fmean also always returns a float, even if the input is an integer.
...
#Heatmap are utilized to visually show a matrix.
...
#The yellow = highest value, The purple color = lowest value.

#Heat map of correlation coefficients using the corrcoef() method.
